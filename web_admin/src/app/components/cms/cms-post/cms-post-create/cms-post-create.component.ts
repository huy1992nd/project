...
@Component({
  selector: 'app-cms-post-create',
  templateUrl: './cms-post-create.component.html',
  styleUrls: ['./cms-post-create.component.css']
})
export class CmsPostCreateComponent implements OnInit {
