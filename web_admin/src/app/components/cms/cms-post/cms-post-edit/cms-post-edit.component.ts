...
@Component({
	selector: 'app-cms-post-edit',
	templateUrl: './cms-post-edit.component.html',
	styleUrls: ['./cms-post-edit.component.css']
})
export class CmsPostEditComponent implements OnInit {
	public config:any;
	constructor(
