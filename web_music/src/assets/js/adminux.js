    ...
    //$(window).on("load", function(){
        ...
        function menuitems(){            
            if(body_1.hasClass('horizontal-menu') === false){
                ...
                $('.sidebar-left #side-menu li a').on('click', function(){
                ...
                if( $(window).width() >=1020){
                    ...
                    $('.sidebar-left #side-menu > li').on('click', function(){    // If you required on hover please checkge 'click' to 'mouseover'
                    ...
                    $('.sidebar-left #side-menu > li ').on('mouseleave', function(){
                        if( $(this).find('a:first-of-type').hasClass('menudropdown')==true){ 
        ...
        $(".filemenu_btn").on("click", function(){
            $(".filemenu ").$(".filemenu ").toggleClass("filemenuopen");("filemenuopen");
        });
